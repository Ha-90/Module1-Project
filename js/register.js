 // check realtime pass nhập lại có khớp pass trước hay không
        ...
        pass2.addEventListener('keyup', function () {
            if (pass1.value == pass2.value) {
                document.getElementById("notification").innerHTML = "Mật khẩu đã trùng khớp";
            } else {
                document.getElementById("notification").innerHTML = "Mật khẩu chưa trùng khớp";
            }
        })
    ...
    function checkPass(e) {
      ...
      if (email == null || email == "") {
        document.getElementById("message_email").innerHTML = "Email không được bỏ trống";
        return false;
      }
     ...
     let pattern = /^(([^<>()[\]\.,;:\s@\"]+(\.[^<>()[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i;
      ...
      if ((firstPass == null || firstPass == "") && (secondPass == null || secondPass == "")) {
        document.getElementById("notification").innerHTML = "Password không được bỏ trống";
        return false;
      }
      ...
      if ((firstPass != secondPass) || (secondPass == null) || (firstPass.length < 8)) {
        document.getElementById("notification").innerHTML = "Password chưa đạt điều kiện";
        return false;
      } else {
